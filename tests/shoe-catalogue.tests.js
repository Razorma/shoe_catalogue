describe('shoeCatalogue Function tests', function () {
    ...
    it('should get the required shoe', function () {
      ...
      assert.deepEqual(display.getShoe(), {name: "Air Jordans",color: "orange", brand: "adidas", price: 575, size: 6, stock: 2 });
    });
    it('should get the required shoe', function () {
        let display = shoeCatalogue();
        display.setTheShoe(shoes, "blue", "Nike", 5);
        assert.deepEqual(display.getShoe(), {name: "Air Jordans",color: "blue", brand: "Nike", price: 650, size: 5, stock: 4 });
      });
  });
